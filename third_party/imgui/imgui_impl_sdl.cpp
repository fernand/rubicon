...
// Missing features:
//  [ ] Platform: SDL2 handling of IME under Windows appears to be broken and it explicitly disable the regular Windows
//  IME. You can restore Windows IME by compiling SDL with SDL_DISABLE_WINDOWS_IME.
...
//  2022-03-22: Inputs: Fix mouse position issues when dragging outside of boundaries. SDL_CaptureMouse() erroneously
//  still gives out LEAVE events when hovering OS decorations. 2022-03-22: Inputs: Added support for extra mouse buttons
...
static void ImGui_ImplSDL2_UpdateMouseData()
{
    ...
    if (is_app_focused)
    {
        ...
        // (Optional) Fallback to provide mouse position when focused (SDL_MOUSEMOTION already provides this when
        // hovered or captured)
